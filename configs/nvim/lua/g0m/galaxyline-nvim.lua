local s = require 'g0m.utils'.symbols
...
gl.section.left = {
  ...
  },
  {
    FileIcon = {
      ...
      provider = function ()
        vim.cmd('hi GalaxyFileIcon guifg='..require'galaxyline.providers.fileinfo'.get_file_icon_color()..' guibg='..require'lush_theme.g0m'.StatusLine.bg.hex)
