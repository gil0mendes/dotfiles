...
wo.colorcolumn    = '120' -- show column boarder
...
-- Set colorscheme
require'g0m.theme'.extraLushSpecs = {
  'lush_theme.g0m.bufferline-nvim',
  'lush_theme.g0m.statusline',
  'lush_theme.g0m.telescope-nvim',
}
cmd 'colorscheme g0m'
